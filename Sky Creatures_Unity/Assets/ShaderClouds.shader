...
Shader "Shader Forge/ShaderClouds" {
    Properties {
        ...
        _GradientOutline ("GradientOutline", 2D) = "white" {}
        _ValueMaxStuff ("ValueMaxStuff", Float ) = 0
...
////// Emissive:
                ...
                float node_3287 = sqrt((_Perlin4_var.r+_Perlin3_var.r));
                float node_2051_if_leA = step(node_3287,_SizeClouds);
                float node_2051_if_leB = step(_SizeClouds,node_3287);
                ...
                float3 node_2051 = lerp((node_2051_if_leA*lerp(_node_8369.rgb,_node_9897.rgb,saturate(floor(node_3287 * _PosterizeStrength) / (_PosterizeStrength - 1))))+(node_2051_if_leB*node_700),node_700,node_2051_if_leA*node_2051_if_leB);
                float3 emissive = node_2051;
                float3 finalColor = emissive;
                float node_8862_if_leA = step(node_3287,(_SizeClouds+max((_OutlineThickness*0.01),0.0)));
                float node_8862_if_leB = step((_SizeClouds+max((_OutlineThickness*0.01),0.0)),node_3287);
                float node_5298 = 0.0;
