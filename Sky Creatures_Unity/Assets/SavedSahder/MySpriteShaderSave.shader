...
////// Emissive:
                ...
                float node_4257 = ((_ProgressApparition*1.2+0.4)+max((_OutlineThickness*0.01),0.0));
                ...
                float node_2970 = 5.0;
                float3 node_4797 = lerp(float3(0,0,0),float3(0.4264706,0.4264706,0.4264706),(sin((frac((floor(_node_8373_var.r * node_4788) / (node_4788 - 1)+node_3783.g))*3.141592654))+floor(_node_6153_var.r * node_2970) / (node_2970 - 1)));
                float4 node_2434 = Function_node_8712( lerp(node_4149,_MainTex_var.a,saturate(floor(lerp((node_8401_if_leA*node_665)+(node_8401_if_leB*node_7480),node_7480,node_8401_if_leA*node_8401_if_leB) * node_5979) / (node_5979 - 1))) , lerp(node_4149,_MainTex_var.a,saturate(floor(lerp((node_720_if_leA*node_665)+(node_720_if_leB*node_7480),node_7480,node_720_if_leA*node_720_if_leB) * node_8544) / (node_8544 - 1))) , _ColorOutline.rgb , lerp((node_4797-float3(0.7,0.7,0.7)),_MainTex_var.rgb,saturate((_ProgressApparition*1.1+0.0))) , _MarginAlpha ).rgba;
